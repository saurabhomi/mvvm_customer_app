...
public class HourlyAdapter extends BaseAdapter {
    ...
    public HourlyAdapter(List<HourlyPackage> hourlyPackages, Context context, String hint) {
        hourlyPackages.add(0, new HourlyPackage().setName("Select"));
    ...
    @Override
    public int getCount() {
        return hourlyPackages.size();
    }

    @Override
    public Object getItem(int i) {
        return hourlyPackages.get(i);
    }
    ...
    private View getSelectedView(ViewGroup parent, final int position) {
        ...
        t.setText(hourlyPackages.get(position).getName());
        return view;
    }
    ...
    private View getCustomView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.mTextView.setText(hourlyPackages.get(position).getName());
