...
import com.ecocustomerapp.ui.singledateandtimepicker.SingleDateAndTimePicker;
...
import static com.ecocustomerapp.ui.singledateandtimepicker.widget.SingleDateAndTimeConstants.STEP_MINUTES_DEFAULT;

public class SingleDateAndTimePickerDialog extends BaseDialog implements View.OnClickListener {
    ...
    public SingleDateAndTimePickerDialog setCloseListener(CloseListener closeListener) {
    ...
    public void close() {
        ...
        if (listener != null && okClicked) {
            if (format != null) {
                String dateTime = format.format(picker.getDate());
                String date = format.format(picker.getDate()).split(" ")[0];
                String time = format.format(picker.getDate()).split(" ")[1];
                listener.onDateSelected(date, time, dateTime);
            }
        }
    }
    ...
    public interface Listener {
        void onDateSelected(String date, String time, String dateTime);
    }
    ...
    public static class Builder {
        ...
        public Builder closeListener(@Nullable CloseListener closeListener) {
            this.closeListener = closeListener;
            return this;
        }
