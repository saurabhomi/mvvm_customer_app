...
public abstract class BaseFragment<C, B extends ViewDataBinding, V extends BaseViewModel> extends Fragment {
    ...
    public C setCallback(C callback) {
    ...
    private FragmentComponent getBuildComponent() {
        return DaggerFragmentComponent.builder()
                .appComponent(((EcoApplication) (getContext().getApplicationContext())).appComponent)
