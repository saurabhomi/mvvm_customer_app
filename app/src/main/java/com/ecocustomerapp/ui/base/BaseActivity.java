...
import com.ecocustomerapp.di.component.DaggerActivityComponent;
...
import com.ecocustomerapp.utils.NetworkUtils;
...
public abstract class BaseActivity<B extends ViewDataBinding, V extends BaseViewModel> extends AppCompatActivity implements BaseFragment.Callback {
    ...
    private ActivityComponent getBuildComponent() {
        return DaggerActivityComponent.builder()
                .appComponent(((EcoApplication)getApplication()).appComponent)
